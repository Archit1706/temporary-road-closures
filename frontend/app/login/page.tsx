                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`mt-1 appearance-none relative block w-full px-5 py-2.5 border ${errors.username ? 'border-red-300' : 'border-gray-300'
                                    } rounded-full placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm transition-all`}
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    className={`appearance-none relative block w-full px-5 py-2.5 pr-10 border ${errors.password ? 'border-red-300' : 'border-gray-300'
                                        } rounded-full placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm transition-all`}
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={loading}
                                className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-bold uppercase tracking-widest rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all shadow-lg active:scale-[0.98]"
                            >
                                {loading ? (
                                    <>
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <a
                                ...
                                className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 rounded-full shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                            >
